 ...
 * ```
 */
public fun View.fadeOut(duration: Long = 300L, hideOnComplete: Boolean = true, onComplete: (() -> Unit)? = null) {
 ...
 * ```
 */
public fun View.setPaddings(left: Int, top: Int, right: Int, bottom: Int) {
