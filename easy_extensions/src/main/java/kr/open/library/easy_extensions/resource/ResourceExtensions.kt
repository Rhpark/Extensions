package kr.open.library.easy_extensions.resource
 ...
 */
public fun Context.getDimensionPixelSize(@DimenRes dimenRes: Int): Int =
 ...
 */
public fun Context.getDimensionPixelOffset(@DimenRes dimenRes: Int): Int =
 ...
 */
public fun Context.getStringFormatted(@StringRes stringRes: Int, vararg args: Any): String =
 ...
 */
public fun Context.getStringArray(arrayRes: Int): Array<String> =
 ...
 */
public fun Context.getInteger(intRes: Int): Int =
 ...
 */
public fun Context.getDrawableSafe(@DrawableRes drawableRes: Int): Drawable? =
    try {
        ContextCompat.getDrawable(this, drawableRes)
 ...
 */
public fun Context.getColorSafe(@ColorRes colorRes: Int, defaultColor: Int): Int =
    try {
        ContextCompat.getColor(this, colorRes)
    } catch (e: android.content.res.Resources.NotFoundException) {
        defaultColor
 ...
 */
public fun Context.getStringSafe(@StringRes stringRes: Int): String =
    try {
        getString(stringRes)
    } catch (e: android.content.res.Resources.NotFoundException) {
        ""
